...
def doLap(image, laplacian_kernel_size=5, gaussian_blur_kernel_size=5):
    ...
    blurred = cv2.GaussianBlur(image, (gaussian_blur_kernel_size,gaussian_blur_kernel_size), 0)
    return cv2.Laplacian(blurred, cv2.CV_64F, ksize=laplacian_kernel_size)

#
#   This routine finds the points of best focus in all images and produces a merged result...
#
def focus_stack(unimages, laplacian_kernel_size=5, gaussian_blur_kernel_size=5):
