<template>
  <v-container class="pa-0" style="width: 100%; height: 100%;" fluid>
    <div id="scroll" style="height:100%; overflow:auto; display:block;" @scroll="viewImage()">
        <div class="previewBlock" style='height:0px;background-color: transparent;' id="scrollinterDiv">
          <img src="" id="image_div" style="overflow: hidden;position:fixed; width:65%; height:85%; margin-top: 30px;z-index:1;display:block;border:black solid 1px;"
           alt="Choose your images" ref="song" />
        </div>
    </div>
  </v-container>
</template>
...
export default {
  ...
  computed: {
    ...
    getClasses() {
      // document.getElementById('scrollinterDiv').style.removeProperty('theme--light')
